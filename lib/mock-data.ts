...
export const SEED_DOCTORS: DoctorProfile[] = [
  // --- Featured (top of list for demo) ---
  { id: 'dr-027', name: 'Dr. Mohan Das', subspeciality: 'Pediatric Surgery', yearsExperience: 20, pgCollege: 'AIIMS Delhi', workingHospital: 'AIIMS Delhi', fee: 1300, rating: 4.9, consultationCount: 500, languages: ['English', 'Hindi'], city: 'Delhi', bio: 'India\'s foremost pediatric surgeon for neonatal surgical emergencies and complex congenital anomalies. Offers pre-surgical consultations via video.', imageUrl: 'https://api.dicebear.com/9.x/avataaars/svg?seed=MohanDas&backgroundColor=65c9ff', availability: [{ day: 'Monday', time: '02:00 PM' }, { day: 'Monday', time: '02:30 PM' }, { day: 'Thursday', time: '10:00 AM' }, { day: 'Thursday', time: '10:30 AM' }, { day: 'Saturday', time: '09:00 AM' }] },
  // --- Cardiology ---
  { id: 'dr-001', name: 'Dr. Priya Sharma', subspeciality: 'Cardiology', yearsExperience: 12, pgCollege: 'AIIMS Delhi', workingHospital: 'Narayana Health', fee: 800, rating: 4.8, consultationCount: 245, languages: ['English', 'Hindi', 'Kannada'], city: 'Bangalore', bio: 'Specializes in congenital heart defects and pediatric arrhythmias. Known for her compassionate approach with anxious parents and thorough echocardiogram interpretations.', availability: [{ day: 'Monday', time: '09:00 AM' }, { day: 'Monday', time: '09:30 AM' }, { day: 'Wednesday', time: '02:00 PM' }, { day: 'Friday', time: '11:00 AM' }] },
  ...
  // --- Nephrology ---
  { id: 'dr-009', name: 'Dr. Vikram Singh', subspeciality: 'Nephrology', yearsExperience: 11, pgCollege: 'PGIMER Chandigarh', workingHospital: 'Max Hospital', fee: 950, rating: 4.5, consultationCount: 175, languages: ['English', 'Hindi', 'Punjabi'], city: 'Delhi', bio: 'Manages nephrotic syndrome, urinary tract infections, and childhood hypertension. Advocates for early screening in at-risk children to prevent kidney damage.', availability: [{ day: 'Tuesday', time: '09:00 AM' }, { day: 'Thursday', time: '04:00 PM' }] },
  ...
  { id: 'dr-012', name: 'Dr. Rohit Agarwal', subspeciality: 'Endocrinology', yearsExperience: 7, pgCollege: 'AIIMS Delhi', workingHospital: 'Medanta Hospital', fee: 1000, rating: 4.6, consultationCount: 130, languages: ['English', 'Hindi'], city: 'Delhi', bio: 'Specializes in precocious puberty, adrenal disorders, and bone metabolism issues. Committed to helping families navigate complex hormonal conditions with clarity.', availability: [{ day: 'Tuesday', time: '02:00 PM' }, { day: 'Thursday', time: '09:00 AM' }, { day: 'Saturday', time: '11:00 AM' }] },
  // --- Hematology ---
  { id: 'dr-013', name: 'Dr. Pooja Deshmukh', subspeciality: 'Hematology', yearsExperience: 11, pgCollege: 'AIIMS Delhi', workingHospital: 'Tata Memorial', fee: 1100, rating: 4.8, consultationCount: 200, languages: ['English', 'Hindi', 'Marathi'], city: 'Mumbai', bio: 'Expert in thalassemia management and bleeding disorders. Works closely with families on transfusion protocols and iron chelation therapy.', availability: [{ day: 'Monday', time: '09:00 AM' }, { day: 'Wednesday', time: '10:00 AM' }, { day: 'Friday', time: '02:00 PM' }] },
  { id: 'dr-014', name: 'Dr. Naveen Joshi', subspeciality: 'Hematology', yearsExperience: 9, pgCollege: 'CMC Vellore', workingHospital: 'Narayana Health', fee: 900, rating: 4.6, consultationCount: 165, languages: ['English', 'Kannada', 'Hindi'], city: 'Bangalore', bio: 'Focused on pediatric anemia workups and coagulation disorders. Passionate about early diagnosis of rare blood conditions.', availability: [{ day: 'Tuesday', time: '11:00 AM' }, { day: 'Thursday', time: '03:00 PM' }] },
  // --- Oncology ---
  { id: 'dr-015', name: 'Dr. Ritu Kapoor', subspeciality: 'Oncology', yearsExperience: 16, pgCollege: 'PGIMER Chandigarh', workingHospital: 'Tata Memorial', fee: 1500, rating: 4.9, consultationCount: 350, languages: ['English', 'Hindi'], city: 'Mumbai', bio: 'Renowned pediatric oncologist specializing in leukemia and solid tumors. Known for her empathetic communication during difficult diagnoses.', availability: [{ day: 'Monday', time: '10:00 AM' }, { day: 'Thursday', time: '02:00 PM' }] },
  { id: 'dr-016', name: 'Dr. Suresh Babu', subspeciality: 'Oncology', yearsExperience: 12, pgCollege: 'Kidwai Memorial', workingHospital: 'HCG Hospital', fee: 1200, rating: 4.7, consultationCount: 230, languages: ['English', 'Kannada', 'Telugu'], city: 'Bangalore', bio: 'Specializes in brain tumors and late-effects management in childhood cancer survivors. Advocates for psychosocial support alongside treatment.', availability: [{ day: 'Wednesday', time: '09:00 AM' }, { day: 'Friday', time: '11:00 AM' }] },
  // --- Rheumatology ---
  ...
  { id: 'dr-020', name: 'Dr. Thomas Philip', subspeciality: 'Infectious Diseases', yearsExperience: 11, pgCollege: 'JIPMER Puducherry', workingHospital: 'Amrita Hospital', fee: 900, rating: 4.6, consultationCount: 220, languages: ['English', 'Malayalam'], city: 'Kochi', bio: 'Specializes in vaccine-preventable diseases and HIV management in children. Active in community outreach for immunization awareness.', availability: [{ day: 'Tuesday', time: '09:00 AM' }, { day: 'Thursday', time: '10:00 AM' }] },
  // --- Allergy & Immunology ---
  { id: 'dr-021', name: 'Dr. Neha Gupta', subspeciality: 'Allergy & Immunology', yearsExperience: 9, pgCollege: 'AIIMS Delhi', workingHospital: 'Max Hospital', fee: 800, rating: 4.6, consultationCount: 170, languages: ['English', 'Hindi'], city: 'Delhi', bio: 'Specializes in food allergy diagnosis, desensitization protocols, and primary immunodeficiency evaluation. Helps families navigate allergen-free lifestyles.', availability: [{ day: 'Monday', time: '11:00 AM' }, { day: 'Wednesday', time: '04:00 PM' }, { day: 'Friday', time: '10:00 AM' }] },
  { id: 'dr-022', name: 'Dr. Ramya Srinivas', subspeciality: 'Allergy & Immunology', yearsExperience: 7, pgCollege: 'St. Johns Bangalore', workingHospital: 'Columbia Asia', fee: 750, rating: 4.5, consultationCount: 120, languages: ['English', 'Kannada', 'Tamil'], city: 'Bangalore', bio: 'Focused on eczema management and allergic rhinitis in children. Uses patch testing and elimination diets to identify triggers.', availability: [{ day: 'Tuesday', time: '02:00 PM' }, { day: 'Thursday', time: '09:00 AM' }] },
  // --- Neonatology ---
  { id: 'dr-023', name: 'Dr. Arun Prakash', subspeciality: 'Neonatology', yearsExperience: 16, pgCollege: 'CMC Vellore', workingHospital: 'Cloudnine Hospital', fee: 1000, rating: 4.9, consultationCount: 400, languages: ['English', 'Tamil', 'Hindi'], city: 'Chennai', bio: 'One of South India\'s top neonatologists. Expert in premature baby care, NICU follow-up, and developmental screening of high-risk newborns.', availability: [{ day: 'Monday', time: '08:00 AM' }, { day: 'Wednesday', time: '08:00 AM' }, { day: 'Friday', time: '08:00 AM' }] },
  { id: 'dr-024', name: 'Dr. Sneha Kulkarni', subspeciality: 'Neonatology', yearsExperience: 10, pgCollege: 'KEM Mumbai', workingHospital: 'Surya Hospital', fee: 950, rating: 4.7, consultationCount: 280, languages: ['English', 'Hindi', 'Marathi'], city: 'Mumbai', bio: 'Specializes in breastfeeding support for NICU graduates and jaundice management. Known for her reassuring approach with first-time parents.', availability: [{ day: 'Tuesday', time: '08:30 AM' }, { day: 'Thursday', time: '08:30 AM' }, { day: 'Saturday', time: '09:00 AM' }] },
  ...
  // --- Pediatric Surgery ---
  { id: 'dr-028', name: 'Dr. Divya Hegde', subspeciality: 'Pediatric Surgery', yearsExperience: 11, pgCollege: 'Kasturba Medical College', workingHospital: 'Manipal Hospital', fee: 1000, rating: 4.7, consultationCount: 195, languages: ['English', 'Kannada', 'Tulu'], city: 'Mangaluru', bio: 'Specializes in minimally invasive surgery for hernias, appendicitis, and undescended testes. Excellent at explaining surgical options to worried families.', availability: [{ day: 'Wednesday', time: '09:00 AM' }, { day: 'Friday', time: '11:00 AM' }, { day: 'Saturday', time: '10:00 AM' }] },
  // --- Orthopedics ---
  { id: 'dr-029', name: 'Dr. Ajay Bhat', subspeciality: 'Orthopedics', yearsExperience: 14, pgCollege: 'AIIMS Delhi', workingHospital: 'Fortis Hospital', fee: 1000, rating: 4.7, consultationCount: 310, languages: ['English', 'Hindi', 'Kannada'], city: 'Bangalore', bio: 'Pediatric orthopedic surgeon specializing in clubfoot correction, scoliosis, and sports injuries in adolescents. Uses Ponseti method for infant foot deformities.', availability: [{ day: 'Monday', time: '09:00 AM' }, { day: 'Wednesday', time: '11:00 AM' }, { day: 'Friday', time: '03:00 PM' }] },
  { id: 'dr-030', name: 'Dr. Pallavi Sen', subspeciality: 'Orthopedics', yearsExperience: 9, pgCollege: 'PGIMER Chandigarh', workingHospital: 'Kokilaben Hospital', fee: 950, rating: 4.6, consultationCount: 180, languages: ['English', 'Hindi', 'Bengali'], city: 'Mumbai', bio: 'Focused on growing bone fracture management and limb deformity corrections. Expertise in hip dysplasia screening and early intervention.', availability: [{ day: 'Tuesday', time: '10:00 AM' }, { day: 'Thursday', time: '02:00 PM' }] },
  // --- Dermatology ---
  ...
  { id: 'dr-032', name: 'Dr. Manoj Tiwari', subspeciality: 'Dermatology', yearsExperience: 12, pgCollege: 'KEM Mumbai', workingHospital: 'Lilavati Hospital', fee: 850, rating: 4.7, consultationCount: 290, languages: ['English', 'Hindi', 'Marathi'], city: 'Mumbai', bio: 'Expert in childhood psoriasis, vitiligo, and hemangiomas. Combines topical therapy with lifestyle guidance for long-term skin health.', availability: [{ day: 'Tuesday', time: '09:00 AM' }, { day: 'Thursday', time: '11:00 AM' }, { day: 'Saturday', time: '10:00 AM' }] },
  // --- Ophthalmology ---
  { id: 'dr-033', name: 'Dr. Rekha Pillai', subspeciality: 'Ophthalmology', yearsExperience: 15, pgCollege: 'Sankara Nethralaya', workingHospital: 'Aravind Eye Hospital', fee: 800, rating: 4.8, consultationCount: 350, languages: ['English', 'Tamil', 'Malayalam'], city: 'Chennai', bio: 'Leading pediatric ophthalmologist for squint correction and amblyopia management. Screens premature babies for retinopathy of prematurity (ROP).', availability: [{ day: 'Monday', time: '09:00 AM' }, { day: 'Wednesday', time: '09:00 AM' }, { day: 'Friday', time: '09:00 AM' }] },
  { id: 'dr-034', name: 'Dr. Sameer Dixit', subspeciality: 'Ophthalmology', yearsExperience: 10, pgCollege: 'AIIMS Delhi', workingHospital: 'Centre for Sight', fee: 900, rating: 4.6, consultationCount: 200, languages: ['English', 'Hindi'], city: 'Delhi', bio: 'Focused on childhood vision screening and congenital eye conditions. Manages pediatric glaucoma and cataracts with a family-centered approach.', availability: [{ day: 'Tuesday', time: '10:00 AM' }, { day: 'Thursday', time: '03:00 PM' }] },
  // --- ENT ---
  { id: 'dr-035', name: 'Dr. Girish Nayak', subspeciality: 'ENT (Otolaryngology)', yearsExperience: 13, pgCollege: 'Kasturba Medical College', workingHospital: 'Manipal Hospital', fee: 850, rating: 4.7, consultationCount: 270, languages: ['English', 'Kannada', 'Hindi'], city: 'Bangalore', bio: 'Pediatric ENT specialist managing recurrent ear infections, adenoid hypertrophy, and hearing loss. Expert in cochlear implant candidacy assessment.', availability: [{ day: 'Monday', time: '02:00 PM' }, { day: 'Wednesday', time: '10:00 AM' }, { day: 'Friday', time: '11:00 AM' }] },
  { id: 'dr-036', name: 'Dr. Isha Malhotra', subspeciality: 'ENT (Otolaryngology)', yearsExperience: 8, pgCollege: 'PGIMER Chandigarh', workingHospital: 'Medanta Hospital', fee: 900, rating: 4.5, consultationCount: 155, languages: ['English', 'Hindi', 'Punjabi'], city: 'Delhi', bio: 'Specializes in pediatric airway problems, snoring evaluation, and tonsillitis management. Uses video laryngoscopy for accurate diagnosis in young children.', availability: [{ day: 'Tuesday', time: '11:00 AM' }, { day: 'Thursday', time: '09:00 AM' }, { day: 'Saturday', time: '10:00 AM' }] },
]
